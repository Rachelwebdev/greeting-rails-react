...
# 📖 greeting-rails-react <a name="about-project"></a>
...
```sh
  cd your-folder
  git clone git@github.com:Rachelwebdev/greeting-rails-react.git
```
...
Feel free to check the [issues page](https://github.com/Rachelwebdev/greeting-rails-react/issues).
